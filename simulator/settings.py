...
flags.DEFINE_integer('vehicles', 4000, "number of vehicles")
flags.DEFINE_integer('dummy_vehicles', 2000, "number of vehicles using dummy agent")
flags.DEFINE_integer('dqn_vehicles', 2000, "number of vehicles using dqn agent")
